...
{
    public partial class OrigenAtenea : Form
    {
        public OrigenAtenea()
        {
            InitializeComponent();
        ...
        private void getdatos()
        {
            try
            {
                ...
                dataGridViewOrigen.DataSource = from c in a.ConfiguracionOrigen3WM
                                                select new
                                                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (lblID.Text != "-")
            {
                ...
                var buscar = from c in a.ConfiguracionOrigen3WM where c.uiRegistroOrigen == id select c;
                if (txtBxOrigen.Text != "")
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (lblID.Text == "-")
            {
                ...
                ConfiguracionOrigen3WM c = new ConfiguracionOrigen3WM();
                ...
                a.ConfiguracionOrigen3WM.InsertOnSubmit(c);
                a.SubmitChanges();
                limpiar();
                getdatos();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (lblID.Text != "-")
            {
                ...
                {
                    int id = Convert.ToInt32(lblID.Text);
                    var buscarOrigen = from c in a.ConfiguracionOrigen3WM where c.uiRegistroOrigen == id select c;
                    a.ConfiguracionOrigen3WM.DeleteOnSubmit(buscarOrigen.First());
                    a.SubmitChanges();
                    limpiar();
                    getdatos();
                }
        ...
        private void menuAteneaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void OrigenAtenea_Load(object sender, EventArgs e)
        {
            getdatos();
        }
    }
