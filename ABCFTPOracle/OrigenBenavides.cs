...
{
    public partial class OrigenBenavides : Form
    {
        public OrigenBenavides()
        {
            InitializeComponent();
        }

        private void OrigenBenavides_Load(object sender, EventArgs e)
        {
            getdatos();
        }
        ...
        private void getdatos()
        {
            try
            {
                ...
                dataGridViewOrigen.DataSource = from c in a.ConfiguracionOrigenBenavides
                                                select new
                                                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (lblID.Text == "-")
            {
                ...
                ConfiguracionOrigenBenavides c = new ConfiguracionOrigenBenavides();
                ...
                a.ConfiguracionOrigenBenavides.InsertOnSubmit(c);
                a.SubmitChanges();
                limpiar();
                getdatos();
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (lblID.Text != "-")
            {
                ...
                var buscar = from c in a.ConfiguracionOrigenBenavides where c.uiRegistroOrigen == id select c;
                if (txtBxOrigen.Text != "")
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (lblID.Text != "-")
            {
                ...
                {
                    int id = Convert.ToInt32(lblID.Text);
                    var buscarOrigen = from c in a.ConfiguracionOrigenBenavides where c.uiRegistroOrigen == id select c;
                    a.ConfiguracionOrigenBenavides.DeleteOnSubmit(buscarOrigen.First());
                    a.SubmitChanges();
                    limpiar();
                    getdatos();
                }
