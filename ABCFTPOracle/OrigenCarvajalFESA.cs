...
{
    public partial class OrigenCarvajalFESA : Form
    {
        public OrigenCarvajalFESA()
        {
            InitializeComponent();
        }

        private void OrigenCarvajalFESA_Load(object sender, EventArgs e)
        {
            getdatos();
        }
        ...
        private void getdatos()
        {
            try
            {
                ...
                dataGridViewOrigenCravajal.DataSource = from c in a.ConfiguracionOrigenCarvajalFESA
                                                        select new
                                                        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (lblID.Text == "-")
            {
                ...
                ConfiguracionOrigenCarvajalFESA c = new ConfiguracionOrigenCarvajalFESA();
                ...
                a.ConfiguracionOrigenCarvajalFESA.InsertOnSubmit(c);
                a.SubmitChanges();
                limpiar();
                getdatos();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (lblID.Text != "-")
            {
                ...
                var buscar = from c in a.ConfiguracionOrigenCarvajalFESA where c.uiRegistroOrigen == id select c;
                if (txtBxOrigen.Text != "")
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (lblID.Text != "-")
            {
                ...
                {
                    int id = Convert.ToInt32(lblID.Text);
                    var buscarOrigen = from c in a.ConfiguracionOrigenCarvajalFESA where c.uiRegistroOrigen == id select c;
                    a.ConfiguracionOrigenCarvajalFESA.DeleteOnSubmit(buscarOrigen.First());
                    a.SubmitChanges();
                    limpiar();
                    getdatos();
                }
        ...
        private void configuaciónCarvajalFESAToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
